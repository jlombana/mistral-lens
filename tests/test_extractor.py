...
from app.extractor import ExtractionResult, extract_document
...
class TestExtractDocument:
    ...
    @patch("app.extractor.extract_answer")
    @patch("app.extractor.extract_topic")
    @patch("app.extractor.extract_text")
    @patch("app.extractor.get_settings")
    def test_full_pipeline(self, mock_settings, mock_ocr, mock_topic, mock_answer, mock_pdf):
        """Should return a complete ExtractionResult."""
        ...
        mock_topic.return_value = "Document about testing."
        mock_answer.return_value = "The answer is 42."
    ...
    @patch("app.extractor.extract_text")
    @patch("app.extractor.get_settings")
    def test_without_question(self, mock_settings, mock_ocr, mock_topic, mock_pdf):
    ...
    @patch("app.extractor.extract_text")
    @patch("app.extractor.get_settings")
    def test_custom_document_id(self, mock_settings, mock_ocr, mock_topic, mock_pdf):
